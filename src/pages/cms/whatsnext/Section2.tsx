...
const WhatsNewSection2 = ({ data, onChange }: any) => {
      ...
      <div className="row">
        <div className="col">
          <Field className="fieldDv">
            ...
            <Input
              name="Heading"
              value={data.sec2_heading}
              onChange={(e) => onChange("sec2_heading", e.target.value)}
            />
          </Field>
        </div>
        <div className="col">
          <Field className="fieldDv">
            ...
            <Input
              ...
              value={data.sec2_link}
              onChange={(e) => onChange("sec2_link", e.target.value)}
            />
          </Field>
        </div>
      </div>
                    ...
                    <div className="uploaded-files-container">
                      <div className="upload-item">
                        {data.sec2_image instanceof File ? (
                          ...
                          <a
                            href={data.sec2_image}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="icon flex items-center gap-5"
                          >
                            <img src={fileIcon} alt="file icon" />
                            {getFileName(data.sec2_image)}
                          </a>
                        )}
                      </div>
                    </div>
...
export default WhatsNewSection2;
