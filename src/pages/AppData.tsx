        ...
        <ToastButtons/>
            ...
            <div className="flex gap-6 flex-wrap mb-20">
                <div className="fileDownloadDv">
                    ...
                    <div className="iconDv"><img src={CsvFileIcon} alt="CSV File" /></div>
                    <div className="templateInfo">
                        <figure><img src={CombustionIcon} alt="Combustion" /></figure>
                        <h3>Combustion</h3>
                        <p>Last Updated: <strong>Jan 15, 2025</strong></p>
                    </div>
                </div>
                <div className="fileDownloadDv">
                    <Button className="downloadBtn">
                    ...
                    <div className="iconDv"><img src={CsvFileIcon} alt="CSV File" /></div>
                    <div className="templateInfo">
                        <figure><img src={RefrigerantIcon} alt="Refrigerant" /></figure>
                        <h3>Refrigerant</h3>
                        <p>Last Updated: <strong>Jan 15, 2025</strong></p>
                    </div>
                </div>
            ...
            <div className="flex gap-6 flex-wrap mb-20">
                <div className="fileDownloadDv locked">
                    <span className="fileLockIcon"><img src={FileLockIcon} alt="File Lock" /></span>
